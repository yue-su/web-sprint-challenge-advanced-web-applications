...
1. Explain what a token is used for.
  ...
  Token is a string returned from the server as an indentifier of the user who had logged in successfully.

2. What steps can you take in your web apps to keep your data secure?

  Each API request needs to go with authrization, and routing to the page of data rendering should be protected by private route.

3. Describe how web servers work.

  Web servers are hosts who are responsible for web application/website storage and management.
